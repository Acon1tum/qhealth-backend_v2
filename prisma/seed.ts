import { PrismaClient, Role, Sex, AppointmentStatus, Priority, MedicalLicenseLevel, PhilHealthAccreditation, NotificationType, NotificationPriority } from '@prisma/client';
  ...
  const notifications = await Promise.all([
    ...
    prisma.notification.create({
      data: {
        ...
        type: NotificationType.HEALTH_SCAN_SHARED,
